...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'txo' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'txo' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'txo' ),
			'200'       => esc_html__( 'Light 200', 'txo' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'txo' ),
			'300'       => esc_html__( 'Book 300', 'txo' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'txo' ),
			'400'       => esc_html__( 'Normal 400', 'txo' ),
			'regular'   => esc_html__( 'Normal 400', 'txo' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'txo' ),
			'500'       => esc_html__( 'Medium 500', 'txo' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'txo' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'txo' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'txo' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'txo' ),
			'700'       => esc_html__( 'Bold 700', 'txo' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'txo' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'txo' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'txo' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'txo' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'txo' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'txo' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'txo' ),
		);
	}
