	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'txo' ),
				'remove'               => esc_html__( 'Remove', 'txo' ),
				'default'              => esc_html__( 'Default', 'txo' ),
				'selectFile'           => esc_html__( 'Select File', 'txo' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'txo' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'txo' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'txo' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'txo' ),
			)
		);
