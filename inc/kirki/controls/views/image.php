...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'txo' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'txo' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'txo' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'txo' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'txo' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'txo' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'txo' ); ?>',
} );
#>
