...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'txo' ),
				'change'       => esc_html__( 'Change image', 'txo' ),
				'default'      => esc_html__( 'Default', 'txo' ),
				'remove'       => esc_html__( 'Remove', 'txo' ),
				'placeholder'  => esc_html__( 'No image selected', 'txo' ),
				'frame_title'  => esc_html__( 'Select image', 'txo' ),
				'frame_button' => esc_html__( 'Choose image', 'txo' ),
			)
		);
	}
